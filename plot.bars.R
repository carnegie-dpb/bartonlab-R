...
plot.bars = function(x, y, pch=0, cex=1, col="black", bg="white", ylim=c(0,0), over=F, log="", xlab="", ylab="") {
  ...
  if (over) {
    ...
    if (ylim[1]!=0 || ylim[2]!=0) {
      plot(xu, yu, pch=pch, cex=cex, ylim=ylim, col=col, bg=bg, log=log, xlab=xlab, ylab=ylab)
    } else {
